# AutoGen 0.4 Sovereign Runtime — 15-Minute Quickstart
...
- Python 3.9+
- pip
- AutoGen 0.4 project (existing or new)
...
handler = SovereignRuntime(act_tier=ACTTier.ACT3)

# Works with any AutoGen 0.4 chain, agent, or LCEL expression
result = chain.invoke(
    {"input": user_input},
...
```python
from enforcement import SovereignAutoGen 0.4, ACTTier

sovereign = SovereignAutoGen 0.4(
