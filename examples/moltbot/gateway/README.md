...
**Reverse proxy that enforces security controls for Moltbot**
...
```mermaid
flowchart TD
    A["Moltbot"] --> B["Gateway (validates)"]
    B --> C["Anthropic API"]
    C -->|if blocked| D["Returns error to Moltbot"]
...
- [Main Moltbot README](../README.md)
- [10-Minute Hardening Guide](../../../guides/moltbot-hardening.md)
