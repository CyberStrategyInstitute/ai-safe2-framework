# AI SAFE² for Moltbot/Clawdbot

**Complete security toolkit for Moltbot users**

---

## 🚨 Quick Navigation

**Just want to secure your Moltbot?** → Start with [10-Minute Hardening Guide](../../guides/moltbot-hardening.md)

**Having issues?** → Check [Troubleshooting Guide](./troubleshooting.md)

**Technical deep-dive?** → See [Full Integration Guide](../../guides/moltbot-integration-guide.md)
...
**File:** [`moltbot_memory.md`](./moltbot_memory.md)

**What it does:** Drop-in file that embeds AI SAFE² safety controls into Moltbot's persistent memory.
...
# Restart Moltbot - safety controls now active
```
...
**What it does:** Scans your Moltbot installation for vulnerabilities and generates risk score.
...
**What it does:** Runs as reverse proxy enforcing AI SAFE² policies between Moltbot and Anthropic API.

**Installation:**
```bash
cd ~/.clawdbot/
git clone https://github.com/CyberStrategyInstitute/ai-safe2-framework.git
cd ai-safe2-framework/examples/moltbot/gateway/
./start.sh
```
...
**Goal:** Secure your personal Moltbot in 10 minutes

1. Run scanner: `python3 scanner.py --path ~/.clawdbot`
...
3. Configure Moltbot to use gateway as proxy
...
**Guide:** [Enterprise Deployment](../../guides/moltbot-enterprise.md)
...
### "API keys in logs"
**Fix:** Set `"redactSensitive": "all"` in `~/.clawdbot/clawdbot.json`
...
**Key Principle:** AI SAFE² runs OUTSIDE Moltbot as independent enforcement layer.
...
|------|---------|-----------|
| `moltbot_memory.md` | Persistent safety controls | Recommended |
...
**Blog:** [Moltbot Security Articles](https://cyberstrategyinstitute.com/tag/moltbot/)

**Resource Map:** [Industry Security Resources](../../resources/moltbot_clawdbot_security_resource_map.md)

---

## Next Steps

1. **Read:** [10-Minute Hardening Guide](../../guides/moltbot-hardening.md)
2. **Run:** `python3 scanner.py --path ~/.clawdbot`
3. **Deploy:** Control gateway for continuous protection
4. **Learn:** [Full integration guide](../../guides/moltbot-integration-guide.md)
