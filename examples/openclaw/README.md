...
[v3.0 Gateway Release Note](https://cyberstrategyinstitute.github.io/ai-safe2-framework/examples/openclaw/gateway-release-v3.0.html)
...
| OpenClaw Gateway | v3.0 | April 2026 | Multi-provider, NEXUS-A2A compatible, 48 tests passing — [full release note](https://cyberstrategyinstitute.github.io/ai-safe2-framework/examples/openclaw/gateway-release-v3.0.html) |
