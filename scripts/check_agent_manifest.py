...
def main() -> int:
    ...
    required_paths = [
        ...
        machine.get("challenge_run_schema"),
        machine.get("challenge_bundle_schema"),
        machine.get("challenge_source_schema"),
        machine.get("challenge_comparison_schema"),
        machine.get("challenge_001_fixture_protocol"),
