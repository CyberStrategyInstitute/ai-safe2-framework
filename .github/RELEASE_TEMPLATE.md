...
**[Ask the practical question this release helps answer.]**

[Explain the result users can obtain now. Keep this focused on outcomes rather
...
[copyable version-check command]
```

### 2. Run the smallest useful example

```console
[copyable command using included, non-sensitive example data]
```

### 3. Inspect or verify the result

```console
[copyable verification or reporting command]
```
...
- [What is not isolated, authenticated, verified, or measured.]
...
- [Package, schema, example, or integration validation.]
- [Known skips or limitations, stated accurately.]

## 🧭 What stays the same?

[Identify framework, control-count, profile, API, or compatibility invariants.]
...
These are roadmap items—not capabilities claimed by this release.
