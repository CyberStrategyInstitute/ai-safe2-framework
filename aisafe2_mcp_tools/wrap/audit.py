...
class AuditLog:
    ...
    def write(self, record: dict[str, Any]) -> None:
        ...
        try:
            ...
            # The proxy remains fail-open for availability, but an audit failure
            # must be observable by operators rather than silently discarded.
            logger.warning("Unable to append MCP audit record: %s", exc)
